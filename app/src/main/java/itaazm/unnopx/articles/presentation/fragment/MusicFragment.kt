...
import itaazm.unnopx.articles.databinding.FragmentMusicBinding
...
class MusicFragment : Fragment(), ArtAdapter.OnItemClickListener, ArtAdapter.OnInsertClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val artList = viewModel.categoryList[1]
